...
namespace api_scango.Controllers.V1
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateProduct(int IdEstablecimiento, [FromBody] ProductoUpdateDTO producto)
        {
            try
            {
                await _productoService.UpdateProducto(IdEstablecimiento, producto);
